 ...
 * @author COMPLAP
 */
public class Boy extends ADULT implements ActionListener {
    ...
    Boy()
    {
        ...
        JLabel label=new JLabel("PACKAGES OPTIONS FOR BOYS");
...
JLabel L5=new JLabel(" 2)   if you select any of our theme package then it's necessary to select one of our dinner package");
       ...
       p.setLayout(new FlowLayout(FlowLayout.CENTER,6000,20));
        r4 =new JRadioButton ("MARVEL PLOTTER 70,000");
      r4.setBackground(Color.WHITE);
      r4.setForeground(Color.BLUE);
       p.add(r4);
        r5=new JRadioButton ("HARRY   POTTER 60,000");
              r5.setBackground(Color.WHITE);
              r5.setForeground(Color.BLUE);

       p.add(r5);
       r6=new JRadioButton ("RED AND BLUE 45,000 ");
      ...
      p.add(Ll);
          r=new JRadioButton   (" Bombay Biryani,Coffe and Lotus Cake: 20,000");
          r.setBackground(Color.WHITE);
          r.setForeground(Color.BLUE);
        r1=new  JRadioButton ("Pulao ,Kashmiri Chai and Coffe Cake :   10,000");
        r1.setBackground(Color.WHITE);
                  r1.setForeground(Color.BLUE);

           r2=new  JRadioButton  ("Cake ,Coffee and Peanuts  :         15,000");
           r2.setBackground(Color.WHITE);
                     r2.setForeground(Color.BLUE);

         r3=new  JRadioButton ("GoodyBags , Coffee and cake  :         16,000");
     ...
     p.add(r3);
      ...
      public void actionPerformed(java.awt.event.ActionEvent evt) {                                    
        ...
        {
         JOptionPane.showMessageDialog(null,"***HERE'S YOUR RECEIPT***"+"\n"+ "MARVEL PLOTTER : 70,000 "+"\n"+"\n"+"Bombay Biryani,Coffe and Lotus Cake: 20,000"+"\n"+"\n"+"SUBTOTAL :"+"90000.0"+"\n"+"------------------------------");  
        ...
        {
         JOptionPane.showMessageDialog(null,"***HERE'S YOUR RECEIPT***"+"\n"+ "MARVEL PLOTTER : 70,000 "+"\n"+"\n"+"Cake ,Coffee and Peanuts  :         15,000"+"\n"+"\n"+"SUBTOTAL :"+"85000.0"+"\n"+"------------------------------");  
        JOptionPane.showMessageDialog(null,"Your order is confirmed we will contact you in 3-4 working days");  
        ...
        {
         JOptionPane.showMessageDialog(null,"***HERE'S YOUR RECEIPT***"+"\n"+ "MARVEL PLOTTER : 70,000 "+"\n"+"\n"+"GoodyBags , Coffee and cake  :         16,000"+"\n"+"\n"+"SUBTOTAL :"+"86000.0"+"\n"+"------------------------------");  
         JOptionPane.showMessageDialog(null,"Your order is confirmed we will contact you in 3-4 working days");  
        ...
        if (r6.isSelected()&&r1.isSelected())
        {
            ...
            JOptionPane.showMessageDialog(null,"***HERE'S YOUR RECEIPT***"+"\n"+ "RED AND BLUE : 45,000 "+"\n"+"\n"+"Pulao ,Kashmiri Chai and Coffe Cake :   10,000"+"\n"+"\n"+"SUBTOTAL :"+"55000.0"+"\n"+"------------------------------");  
        JOptionPane.showMessageDialog(null,"Your order is confirmed we will contact you in 3-4 working days");  
