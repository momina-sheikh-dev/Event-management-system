 ...
 * @author COMPLAP
 */
public class Girl extends ADULT implements ActionListener {
    JButton b1,b2;
    JTextField t;
   ...
   Girl()
    {
      ...
      L5.setForeground(Color.WHITE);
       ...
       r4=new JRadioButton(" BARBIE DOLL 70,000   ");
              r4.setBackground(Color.WHITE);
             r4.setForeground(Color.BLUE); 

       p.add(r4);
       r5=new JRadioButton(" CANDY SHOP  60,000   ");
                        r5.setBackground(Color.WHITE);

r5.setForeground(Color.BLUE); 
       p.add(r5);
       r6=new JRadioButton("WHITE AND PINK 45,000 ");
...
r6.setForeground(Color.BLUE); 
      ...
      p.add(Ll);
       r=new JRadioButton  ("chicken Shashlik , Coffe and Lotus Cake: 30,000");
                     r.setBackground(Color.WHITE);
                     r.setForeground(Color.BLUE);


       r1=new JRadioButton  ("Bombay Biryani , Coffe  and  Malt Cake: 25,000");
